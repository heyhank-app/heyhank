...
* Add permission & plan approval E2E tests ([#6](https://github.com/The-Vibe-Company/claude-code-controller/issues/6)) ([8590a68](https://github.com/The-Vibe-Company/claude-code-controller/commit/8590a68657f0a06e94795a179ad4bbedae782c63))
* Redesign README as a landing page with API-first documentation ([#7](https://github.com/The-Vibe-Company/claude-code-controller/issues/7)) ([a59e1b4](https://github.com/The-Vibe-Company/claude-code-controller/commit/a59e1b4604baf87faa32af7d62e4846afae49dbe))

## [0.1.1](https://github.com/The-Vibe-Company/claude-code-controller/compare/claude-code-controller-v0.1.0...claude-code-controller-v0.1.1) (2026-02-07)


### Bug Fixes

* add web/dist to gitignore ([#2](https://github.com/The-Vibe-Company/claude-code-controller/issues/2)) ([b9ac264](https://github.com/The-Vibe-Company/claude-code-controller/commit/b9ac264fbb99415517636517e8f503d40fe3253d))
