      ...
      >
        ...
        {!isEditing && (
          <span className="flex items-center gap-1 shrink-0">
            ...
            {s.nodeId && (
              <span className="flex items-center gap-0.5 px-1.5 py-0.5 rounded bg-cc-primary/15 text-[9px] font-semibold text-cc-primary leading-none" title={`Remote: ${s.nodeName || s.nodeId}`}>
                {s.nodeName || "Remote"}
              </span>
            )}
          </span>
